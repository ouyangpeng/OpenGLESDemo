...
void HeightMap::render() {
    if (vbo[0] > 0 && ibo[0] > 0) {
        ...
        // Bind attributes
        glVertexAttribPointer(positionAttribute,POSITION_DATA_SIZE_IN_ELEMENTS,
                GL_FLOAT, GL_FALSE, STRIDE, nullptr);
...
void HeightMap::setPositionAttribute(GLuint vPositionAttribute) {
    HeightMap::positionAttribute = vPositionAttribute;
}

void HeightMap::setNormalAttribute(GLuint vNormalAttribute) {
    HeightMap::normalAttribute = vNormalAttribute;
}

void HeightMap::setColorAttribute(GLuint vColorAttribute) {
    HeightMap::colorAttribute = vColorAttribute;
}
