...
Java_com_oyp_openglesdemo_texture_ShadowsRenderer_nativeSurfaceCreate(
...
extern "C"
JNIEXPORT void JNICALL
Java_com_oyp_openglesdemo_texture_ShadowsRenderer_nativeSurfaceChange(
        JNIEnv *env, jobject thiz, jint width, jint height) {
    if (mShadows != nullptr) {
        mShadows->change(width, height);
    }
}

extern "C"
JNIEXPORT void JNICALL
Java_com_oyp_openglesdemo_texture_ShadowsRenderer_nativeDrawFrame(
