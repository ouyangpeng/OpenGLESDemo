...
#ifndef OPENGLESDEMO_BLENDINGSAMPLE_H
#define OPENGLESDEMO_BLENDINGSAMPLE_H
...
public:
    ...
    static void UpdateMatrix(glm::mat4 &mvpMatrix, int angleXRotate, int angleYRotate, float scale,
...
#endif //OPENGLESDEMO_BLENDINGSAMPLE_H
