...
GLuint MipMap2D::CreateMipMappedTexture2D() {
    ...
    glGenTextures(1, &mipMappedTexture2DID);
    ...
    glBindTexture(GL_TEXTURE_2D, mipMappedTexture2DID);
...
GLboolean
MipMap2D::GenMipMap2D(const GLubyte *src, GLubyte **dst, int srcWidth, int srcHeight, int *dstWidth,
                      int *dstHeight) {
    int x, y;
    int texelSize = 3;
