...
//
        ...
        itemShockWave[ITEM_SUBTITLE] = "学习如何实现 动态（水波纹）涟漪 效果"
        ...
        itemUBO[ITEM_TITLE] = "使用uniform 缓冲区对象，即UBO来展示图片"
        ...
        itemMultiThreadRender[ITEM_SUBTITLE] = "学习 MULTI THREAD RENDER 技术"
        ...
        val itemSticker: MutableMap<String, Any> = HashMap()
        itemSticker[ITEM_IMAGE] = R.mipmap.ic_stencil_testing
        itemSticker[ITEM_TITLE] = "学习 OpenGL 贴纸"
        itemSticker[ITEM_SUBTITLE] = "学习 OpenGL 贴纸怎么实现"
        ...
        val itemGreenScreenMattingMix: MutableMap<String, Any> = HashMap()
        itemGreenScreenMattingMix[ITEM_IMAGE] = R.mipmap.ic_green_screen_mix
        itemGreenScreenMattingMix[ITEM_TITLE] = "绿幕抠图 替换 背景"
        itemGreenScreenMattingMix[ITEM_SUBTITLE] = "OpenGL实现一个绿幕抠图,然后替换背景"
        data.add(itemGreenScreenMattingMix)
        typeMapping.put(i++, IMyNativeRendererType.SAMPLE_TYPE_KEY_GREEN_SCREEN_MATTING_MIX)
    }
